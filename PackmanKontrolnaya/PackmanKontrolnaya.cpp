// PackmanKontrolnaya.cpp: определяет точку входа для приложения.
//

#include "stdafx.h"
#include "PackmanKontrolnaya.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_PACKMANKONTROLNAYA, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PACKMANKONTROLNAYA));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PACKMANKONTROLNAYA));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_PACKMANKONTROLNAYA);
...
////	menu.lpszClassName = (LPCWSTR)"Menu";
////
